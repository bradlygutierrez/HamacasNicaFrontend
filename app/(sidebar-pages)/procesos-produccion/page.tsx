...
export default function ProcesosProduccionPage() {
  return (
    <ManagedCatalogPage
      ...
      description="Administra los procesos de producción y tipos de mano de obra disponibles. El costo de este proceso se define por modelo dentro de la fórmula de producción."
